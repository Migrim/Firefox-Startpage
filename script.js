...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateDateWidget() {
        ...
        const specialDays = {
            ...
            '2-11': { emoji: '🔬', description: "International Day of Women and Girls in Science" },
            '2-14': { emoji: '💖', description: "Valentine's Day" },
            '2-20': { emoji: '⚖️', description: "World Day of Social Justice" },
            '3-2': { emoji: '🧛', description: "Discovery of 'Vampire Star' Feeding on Its Neighbor" },
            '3-8': { emoji: '🌷', description: "International Women's Day" },
            '3-14': { emoji: '🥧', description: "Pi Day" },
            '3-20': { emoji: '🌌', description: "Spring Equinox - Also a day to celebrate our galaxy" },
            ...
            '4-10': { emoji: '🕳️', description: "Black Hole Image Release Anniversary" },
            '4-12': { emoji: '🚀', description: "Yuri's Night (First Human in Space)" },
            '4-22': { emoji: '🌎', description: "Earth Day" },
            '4-30': { emoji: '👽', description: "Kepler Telescope Confirms First Earth-Sized Planet in Habitable Zone" },
            '5-1': { emoji: '⚒️', description: "International Workers' Day" },
            '5-4': { emoji: '⭐', description: "Star Wars Day" },
            '5-11': { emoji: '💀', description: "Closest Known Black Hole Discovered" },
            ...
            '6-10': { emoji: '🪐', description: "Discovery of Neptune's Rings" },
            ...
            '6-22': { emoji: '🪦', description: "Discovery of a Star System with a 'Zombie' Star" },
            '6-28': { emoji: '🏳️‍🌈', description: "Stonewall Riots Anniversary" },
            '7-6': { emoji: '🍫', description: "World Chocolate Day" },
            '7-16': { emoji: '🌌', description: "Apollo 11 Moon Landing Anniversary" },
            '7-18': { emoji: '✊', description: "Nelson Mandela International Day" },
            '7-20': { emoji: '🍦', description: "National Ice Cream Day" },
            '7-25': { emoji: '📡', description: "First Detection of an Extraterrestrial Radio Burst" },
            ...
            '8-15': { emoji: '🎙️', description: "Anniversary of the Wow! Signal" },
            '8-19': { emoji: '👐', description: "World Humanitarian Day" },
            '8-20': { emoji: '🌌', description: "Voyager 2 Reaches Interstellar Space" },
            '8-23': { emoji: '📖', description: "International Day for the Remembrance of the Slave Trade and Its Abolition" },
            '8-30': { emoji: '🔦', description: "Strange Flash Observed in Distant Galaxy Cluster" },
            ...
            '9-23': { emoji: '🛸', description: "Mysterious Light Source Detected on Mars by Curiosity Rover" },
            ...
            '10-13': { emoji: '🪐', description: "Saturn Discovered by Galileo" },
            '10-16': { emoji: '🥖', description: "World Food Day" },
            '10-21': { emoji: '🔊', description: "Anniversary of First Detected Mysterious Space Sound" },
            '10-26': { emoji: '🏳️‍⚧️', description: "Intersex Awareness Day" },
            '10-30': { emoji: '🔮', description: "Mysterious Signals Detected from Distant Galaxy" },
            '10-31': { emoji: '🎃', description: "Halloween" },
            '10-31': { emoji: '🌑', description: "Spooky Moon Phase (Darkest Night)" },
            '11-8': { emoji: '⚛️', description: "World Radiography Day" },
            '11-11': { emoji: '🌌', description: "Astronomers Discover Largest Known Galaxy" },
            '11-16': { emoji: '🕳️', description: "Discovery of the First Wandering Black Hole" },
            ...
            '12-14': { emoji: '👻', description: "First Detection of 'Ghost Particle' from Outside Our Galaxy" },
            '12-15': { emoji: '🎅', description: "National Ugly Sweater Day" },
            '12-18': { emoji: '🌌', description: "Discovery of New Exoplanet (random year anniversary)" },
            '12-21': { emoji: '❄️', description: "Winter Solstice" },
